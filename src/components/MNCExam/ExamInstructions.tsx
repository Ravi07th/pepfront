    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <button
            onClick={onBack}
            className="flex items-center space-x-3 text-white hover:opacity-80 transition-all duration-200 bg-white bg-opacity-20 px-4 py-2 rounded-lg"
          >
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold">{examType.name}</h1>
              <p className="text-sm opacity-90">Mock Test Platform</p>
            </div>
          </div>
          <div className="flex items-center space-x-3 bg-white bg-opacity-20 px-4 py-2 rounded-lg">
      ...
      <main className="max-w-7xl mx-auto px-8 py-2">
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200">
          ...
          <div className="px-8 py-2">
            <div className="space-y-5">
              ...
              <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-blue-900">Exam Overview</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-lg">{examType.sections.reduce((total, section) => total + section.duration, 0)} minutes</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-lg">{examType.sections.reduce((total, section) => total + section.questionCount, 0)}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-lg">{examType.sections.length}</p>
                    </div>
                  </div>
                  {company.id === 'microsoft' && (
                    <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-lg">700/1000</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">How to Take the Test</h3>
                </div>
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  <ol className="space-y-4 text-base text-gray-700 leading-relaxed">
                    {instructions.rules.map((rule, index) => (
                      <li key={index} className="flex items-start">
                        <span className="font-bold text-blue-600 mr-3 bg-white rounded-full w-6 h-6 flex items-center justify-center text-xs">
                          {index + 1}
                        </span>
              ...
              <div>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Understanding Question Colors</h3>
                </div>
              ...
              {instructions.additionalNotes && (
                <div>
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Key Information about this Mock Test</h3>
                  </div>
            ...
            {/* Language Selection */}
            <div className="mb-3 mt-2 p-6 bg-gray-50 rounded-xl border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Choose your default language:</h4>
                  <p className="text-sm text-gray-600">This language can be changed for a particular question later on.</p>
                </div>
                <select 
                  value={language}
                  onChange={(e) => setLanguage(e.target.value)}
                  className="border border-gray-300  px-4 py-2 text-sm font-medium bg-white"
                >
            ...
            {/* Agreement Checkbox */}
            <div className="mb-2 p-6 bg-blue-50 border border-blue-200 rounded-xl">
            ...
            <div className="text-center">
              <button
                ...
                disabled={!agreed}
                className={`px-16 py-4 rounded-xl font-bold text-xl transition-all duration-300 transform ${
                  agreed
